...
First, copy the FLUXNET dataset into a "Data" folder in the main directory and update the gitignore. Then, run the preprocessing function on this dataset and update the gitingore again with this new dataset. The cleanest way to be able to run the experiments is by creating a virtual environment. A list of the dependencies needed in this environment can be found in the **requirements.txt** file. Use this file to create the virtual environment.
<!--
