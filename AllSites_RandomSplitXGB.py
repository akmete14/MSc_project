...
df = pd.read_csv('/cluster/home/akmete/MSc/dataframe.csv')
...
X_train = train_dataframe.drop(columns=['GPP', 'site_id']) # test_dataframe_balanced
...
output_file = "XGB_AllSites_strat[20to25]_Random_Split_metrics_and_feature_importances.csv"
