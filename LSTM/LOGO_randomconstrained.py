...
for group_val in tqdm(unique_groups):
    ...
    # Train
    model.fit(train_dataset, epochs=num_epochs, verbose=0, callbacks=[early_stopping])
...
results_df.to_csv("LOGO_random_grouping_constraint_similarsize.csv'", index=False)
print("Done!")