...
df_xgb = pd.read_csv('/cluster/project/math/akmete/MSc/LOGO/XGB_random_grouping_all_metrics.csv')
df_lstm = pd.read_csv('/cluster/project/math/akmete/MSc/LSTM/LOGO_random_grouping.csv')
